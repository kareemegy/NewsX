  ...
  return (
    <>
      <div className="w-full max-w-full px-3 text-center flex-0">
        ...
        <h5 className="font-normal dark:text-white text-slate-400">
          ...
          <div className="flex flex-wrap -mx-3">
            <div className="w-full max-w-full px-3 m-auto flex-0 lg:w-8/12">
              <form className="relative mb-32">
                  ...
                  <div>
                    <div className="flex flex-wrap mt-4 -mx-3">
                      <div className="w-full max-w-full px-3 flex-0 sm:w-4/12">
                        <div className="relative inline-flex items-center justify-center text-white transition-all duration-200 w-28 h-28 text-base ease-soft-in-out rounded-xl">
                          <img
                            className="w-full rounded-lg"
                            src="../../assets/img/team-2.jpg"
                            alt="Image placeholder"
                          />
                          <a className="inline-block w-6 h-6 p-1.2 right-0 bottom-0 absolute -mb-2 -mr-2 font-bold text-center uppercase align-middle transition-all bg-gradient-to-tl from-gray-400 to-gray-100 text-slate-800 border-0 border-transparent border-solid rounded-lg cursor-pointer leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 active:opacity-85">
                            <i className="top-0 fa fa-pen text-3xs"></i>
                          </a>
                        </div>
                      </div>
                      <div className="w-full max-w-full px-3 mt-6 text-left flex-0 sm:w-8/12 sm:mt-0">
                        <label
                ...
                <div className="absolute top-0 left-0 flex flex-col invisible w-full h-0 min-w-0 p-4 break-words bg-white border-0 opacity-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">
                  <div className="flex flex-wrap -mx-3 text-center">
                    <div className="w-10/12 max-w-full px-3 mx-auto flex-0">
                      <h5 className="font-normal dark:text-white">
                  ...
                  <div>
                    <div className="flex flex-wrap mt-6 -mx-3">
                      <div className="w-full max-w-full px-3 ml-auto sm:flex-0 sm:w-3/12 shrink-0">
                        ...
                        <h6 className="select-none dark:text-white">Design</h6>
                      </div>
                      <div className="w-full max-w-full px-3 sm:flex-0 sm:w-3/12 shrink-0">
                        <input
                          id="code"
                          type="checkbox"
                          className="absolute pointer-events-none peer clip-rect-0"
                        ...
                        <h6 className="select-none dark:text-white">Code</h6>
                      </div>
                      <div className="w-full max-w-full px-3 mr-auto sm:flex-0 sm:w-3/12 shrink-0">
                        <input
                          id="develop"
                          type="checkbox"
                          className="absolute pointer-events-none peer clip-rect-0"
                        ...
                        <h6 className="select-none dark:text-white">Develop</h6>
                      </div>
                    </div>
                    <div className="flex mt-6">
                      <button
                ...
                <div className="absolute top-0 left-0 flex flex-col invisible w-full h-0 min-w-0 p-4 break-words bg-white border-0 opacity-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">
                  ...
                  <div>
                    <div className="flex flex-wrap -mx-3 text-left">
                      <div className="w-full max-w-full px-3 mt-4 ml-auto flex-0 md:w-8/12">
                        <label
                          className="mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80"
                          htmlFor="Street Name"
                        >
                      ...
                      <div className="w-full max-w-full px-3 mt-4 ml-auto flex-0 md:w-4/12">
                        <label
                          className="mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80"
                          htmlFor="Street No"
                        >
                      ...
                      <div className="w-full max-w-full px-3 mt-4 ml-auto flex-0 md:w-7/12">
                        <label
                          className="mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80"
                          htmlFor="City"
                        >
                      ...
                      <div className="w-full max-w-full px-3 mt-4 ml-auto flex-0 md:w-5/12">
                        <label
                          className="mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80"
                          htmlFor="Country"
                        >
                    ...
                    <div className="flex flex-wrap -mx-3">
                      <div className="flex w-full max-w-full px-3 mt-6 flex-0">
                        <button
                          type="button"
                          aria-controls="account"
                          prev-form-btn
